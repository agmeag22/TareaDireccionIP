...
public class NetOp {
    ...
    public void generateIPs(EditText clientip, EditText clientsubnet, EditText totalips, EditText clientips, EditText broadcastedittext, EditText netid, EditText mask, EditText bitshost, EditText bitsred,String ip, String subnet){
        ...
        res[6] = ""+ n_subnet;
        netid.setText(res[0]);
        broadcastedittext.setText(res[1]);
